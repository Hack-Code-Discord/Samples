...
/// Creation Date: 08th of December 2018
/// Purpose: Contains information about a low-level keyboard input event.
#region ========================================================================= USING =====================================================================================
using System;
...
namespace KeyLogger
{
    ...
    public struct LowLevelKeyboardInputEvent
    {
        ...
        /// An application can use the following values to test the keystroke Flags. Testing LLKHF_INJECTED (bit 4) will tell you whether the event was injected. 
